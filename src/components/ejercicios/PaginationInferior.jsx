    ...
    return (
        <div className="d-flex justify-content-center mt-5">
          <ul className="text-light pagination pagination-md">
            ...
            <li className="page-item "><Link to={"/cuadriceps"} className="page-link bg-warning  text-dark">1</Link></li>
            <li className="page-item"><Link to={"/femoral"} className="page-link bg-warning text-dark">2</Link></li>
